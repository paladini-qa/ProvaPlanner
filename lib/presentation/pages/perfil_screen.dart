...
class _PerfilScreenState extends State<PerfilScreen> {
  ...
  Future<void> _carregarDadosUsuario() async {
    try {
      ...
      if (profile != null) {
        final notificationsEnabled = await ProfileService.getNotificationsEnabled();
  ...
  Future<void> _carregarFoto() async {
    try {
      final photo = await ProfileService.getPhoto();
  ...
  Future<void> _salvarFoto(dynamic imageFile) async {
    try {
      ...
      try {
        ...
        await ProfileService.setPhoto(imageFile);
        await _carregarFoto();
      }
  ...
  Future<void> _limparDados() async {
    ...
    if (confirmado == true) {
      try {
        // Limpar dados usando ProfileService (inclui foto)
        ...
        // Fallback para SharedPreferences se ProfileService falhar
        final prefs = await SharedPreferences.getInstance();
        await prefs.clear();
